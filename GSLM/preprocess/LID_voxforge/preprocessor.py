...
from LID_voxforge.dataset import VoxforgeDataset, get_dataloader, split_dataset
...
class Preprocessor(PreprocessorBase):
    ...
    def generate_manifest(self):
        ...
        for split in ["train", "valid", "test"]:
            dataset = VoxforgeDataset(data_list=split_data_list[split])
